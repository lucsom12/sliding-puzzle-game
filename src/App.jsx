...
// NEW: Medium–bräde: 3×3 där översta raden redan är rätt
...
export default function App() {
    ...
    const [showDifficultyPage, setShowDifficultyPage] = useState(false); // NEW
    ...
    function handleSizeChange(e) {
        ...
        setSize(newSize);
        resetGame(newSize); // NEW: ändra storlek + skapa nytt bräde
    }

    // NEW: starta spel med vald svårighetsgrad
    function startGameWithDifficulty(level) {
        ...
        if (level === "easy") {
            newSize = 2;
            newTiles = shuffleBoard(2);           // 2×2 helt blandat
        } else if (level === "medium") {
            newSize = 3;
            newTiles = createMediumBoard();       // 3×3, översta raden rätt
        } else {
            newSize = 3;
            newTiles = shuffleBoard(3);           // 3×3 helt blandat
        }
        ...
        setMoveCount(0);
        setBoardFocusMode(false);
        setStatusMessage("Nytt pussel! Använd piltangenterna eller klicka på brickorna.");
        setLiveMessage("Nytt pussel startat.");
                ...
                <div className="button-container">
                    <button
                        ...
                        onClick={() => {
                            ...
                            setShowDifficultyPage(true); // NEW
                        }}
                    >
                        Starta Spelet
                    </button>
    ...
    if (showTutorialPage) {
        return (
            <div className="app tutorial-page">
                ...
                <p>
                    Försök att få alla delar a bilden på rätt plats för att se vad den föreställer
                </p>
                ...
                <button
                    ...
                    onClick={() => {
                        ...
                        setShowDifficultyPage(true); // gå till svårighetsval efter tutorial
                    }}
                >
                    Starta Spelet
                </button>
    ...
    // NEW: Sida för att välja svårighetsgrad
    if (showDifficultyPage) {
        return (
            <div className="app difficulty-page">
                <h1 className="app-title">Välj svårighetsgrad</h1>
                <div className="button-container">
                    <button className="button" onClick={() => startGameWithDifficulty("easy")}>
                        Enkel – 2×2
                    </button>
                    <button className="button" onClick={() => startGameWithDifficulty("medium")}>
                        Medium – 3×3 (översta raden rätt)
                    </button>
                    <button className="button" onClick={() => startGameWithDifficulty("hard")}>
                        Svårt – 3×3 blandad
                    </button>
                </div>
        ...
        >
            ...
            >
                ...
                <div className="control-group">
                    ...
                    <button
                        type="button"
                        onClick={() => setShowDifficultyPage(true)} // öppna svårighetsval in-game om man vill
                    >
                        Svårighetsgrad
                    </button>
